...
SERVICE_KEYWORDS = {
 ...
 "breastfeeding_support": ["breastfeeding","breast feeding","breastfeed","lactation","latch","latching","poor latch","won't latch","wont latch","feeding hurts","painful feeding","painful breastfeeding","sore nipples","cracked nipples","nipple pain","milk supply","low milk supply","oversupply","engorgement","mastitis","blocked ducts","hand expression","express milk","pumping","breast pump","milk storage","cluster feeding","feeding cues","breast milk","antenatal breastfeeding","antenatal breastfeeding preparation","antenatal breastfeeding prep","breastfeeding preparation","prepare for breastfeeding","harvesting colostrum","colostrum harvesting"],
...
def detect_service_key(message: str):
    m=(message or "").lower()
    # Antenatal breastfeeding preparation is a Breastfeeding & Lactation
    # service, not the general Antenatal Education family. This explicit
    # rule also preserves the context after a latching/breastfeeding turn.
    if ("breastfeed" in m or "colostrum" in m) and any(x in m for x in ("antenatal","prenatal","preparation","prep","harvest")):
        return "breastfeeding_support"
